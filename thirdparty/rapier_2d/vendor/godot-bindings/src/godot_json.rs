...
use gdextension_api::version_4_6::{
    load_gdextension_header_h as load_latest_gdextension_headers,
    load_gdextension_header_rs as load_latest_gdextension_rust_bindings,
};
// ]]
...
pub(crate) fn write_gdextension_headers(
    ...
    let rs_contents = load_latest_gdextension_rust_bindings();
    fs::write(out_rs_path, rs_contents.as_ref())
