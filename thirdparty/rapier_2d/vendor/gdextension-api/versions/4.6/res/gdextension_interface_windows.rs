...
pub type GDExtensionInterfaceMemAlloc2 = ::std::option::Option<
    unsafe extern "C" fn(
        p_bytes: usize,
...
pub type GDExtensionInterfaceMemRealloc2 = ::std::option::Option<
    unsafe extern "C" fn(
        p_ptr: *mut ::std::os::raw::c_void,
        p_bytes: usize,
        p_pad_align: GDExtensionBool,
...
pub type GDExtensionInterfaceMemFree2 = ::std::option::Option<
    unsafe extern "C" fn(p_ptr: *mut ::std::os::raw::c_void, p_pad_align: GDExtensionBool),
>;
