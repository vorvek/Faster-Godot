...
// Detect CPU architecture
	...
	#endif
	#if (defined(__F16C__) || (defined(JPH_USE_AVX2) && defined(JPH_COMPILER_MSVC))) && !defined(JPH_USE_F16C)
		#define JPH_USE_F16C
	#endif
	#if (defined(__LZCNT__) || (defined(JPH_USE_AVX2) && defined(JPH_COMPILER_MSVC))) && !defined(JPH_USE_LZCNT)
		#define JPH_USE_LZCNT
	#endif
	#if (defined(__BMI__) || (defined(JPH_USE_AVX2) && defined(JPH_COMPILER_MSVC))) && !defined(JPH_USE_TZCNT)
